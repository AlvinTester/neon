...
def animate():
    for c in itertools.cycle(['\033[1;96m|', '\033[1;92m/', '\033[1;95m-', '\033[1;91m\\']):
        if done:
            break
        sys.stdout.write('\r\033[1;93mOdading ' + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c )
        sys.stdout.flush()
        time.sleep(0.1)
...
logo = """
\033[1;98m   
\033[1;98m     𝑨𝒍𝒗𝒊𝒏 𝑮𝒉𝒂𝒛𝒂𝒍𝒊
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  𝑨𝒍𝒗𝒊𝒏 𝑮𝒉𝒂𝒛𝒂𝒍𝒊                                ║    
\033[1;98m    ║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ☪ .ℝ𝔸𝕋𝕌 𝔼ℝℝ𝕆ℝ.                           ║  
\033[1;96m    ║✯ 𝓦𝓮 𝓐𝓻𝓮 𝓐𝓷𝓸𝓷𝔂𝓶𝓸𝓾𝓼.                                  ║
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
...
def menu():
	...
	print 50* "\033[1;94m─"
	print "\033[1;97m{"+warni+"01\033[1;97m}"+warna+" Crack ID Bangladesh"
	print "\033[1;97m{"+warni+"02\033[1;97m}"+warna+" Crack ID Postingan Grup/Teman"
